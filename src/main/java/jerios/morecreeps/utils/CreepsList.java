...
public class CreepsList {
     ...
     */
    public static void addMapping(Class<? extends net.minecraft.entity.Entity> p_75618_0_, String p_75618_1_,
        int p_75618_2_) {
        if (p_75618_2_ < 0 || p_75618_2_ > Integer.MAX_VALUE - 1) throw new IllegalArgumentException(
            "Attempted to register a entity with invalid ID: " + p_75618_2_
                + " Name: "
                + p_75618_1_
                + " Class: "
                + p_75618_0_);
     ...
     */
    public static void addMapping(Class<? extends net.minecraft.entity.Entity> p_75614_0_, String p_75614_1_,
