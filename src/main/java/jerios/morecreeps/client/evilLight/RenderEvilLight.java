...
public class RenderEvilLight extends CREEPSBaseLivingRender {
    ...
    private static final ResourceLocation TEXTURE = ResourceLocationUtils
        .makeResourceLocationEntityHostile("evillight1");
    private static final ResourceLocation RENDER_EFFECT = ResourceLocationUtils
        .makeResourceLocationEntityHostile("evillightglow");
