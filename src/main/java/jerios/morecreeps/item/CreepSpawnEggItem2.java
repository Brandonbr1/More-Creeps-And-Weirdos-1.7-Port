...
public class CreepSpawnEggItem2 extends ItemMonsterPlacer {

    public CreepSpawnEggItem2()
    {
        super();
    ...
    public static Entity spawnCreature(World p_77840_0_, int p_77840_1_, double p_77840_2_, double p_77840_4_, double p_77840_6_)
    {
        ...
        else
        {
            ...
            for (int j = 0; j < 1; ++j)
            {
                entity = new TrophyEntity(p_77840_0_); //CreepsList.createEntityByID(p_77840_1_, p_77840_0_);
